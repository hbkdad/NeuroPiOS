...
Second-priority: extend `docs/security/ECONOMIC-ATTACKS.md`'s remaining "No" rows (treasury drain modeling, front-running, griefing) with real simulation coverage where feasible.
